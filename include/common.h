...
namespace stardust
{
    ...
    class instance {
        ...
        struct {
          ...
          RESOLVE_TYPE( SafeArrayCreate ),
          RESOLVE_TYPE( SafeArrayCreateVector ),
          RESOLVE_TYPE( SafeArrayAccessData ),
          RESOLVE_TYPE( SafeArrayUnaccessData ),
          RESOLVE_TYPE( SafeArrayPutElement ),
          RESOLVE_TYPE( SafeArrayDestroy ),
          RESOLVE_TYPE( VariantInit ),
          RESOLVE_TYPE( VariantClear )
  };
        ...
        struct {
          uintptr_t handle;
            ...
            RESOLVE_TYPE( CLRCreateInstance )
    };
    ...
    public:
        ...
        auto hostCLR(
            LPCWSTR netVer,
            LPVOID *ppICLRMetaHost,
            ICLRRuntimeInfo * *ppICLRRuntimeInfo,
